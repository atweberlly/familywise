          ...
          <ol className="mx-5">
            <li className="text-left">
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  You may contact us in writing at 61-63 Parry St, Newcastle West, New South Wales,
                  2302 for further information about this Privacy Policy.
                </span>
              </div>
            </li>
          </ol>
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  you submit to our website, provided to us directly or given to us in other forms.
                </span>
              </div>
            ...
            <li className="text-left">
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  ...
                  with information about our products or services. We may also make you aware of new
              ...
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  <div className="mx-2 my-2 flex">
                    ...
                    <span className="flex-grow">administer our business activities;</span>
                  </div>
                  <div className="mx-2 my-2 flex">
                  ...
                  <div className="mx-2 my-2 flex">
                    ...
                    <span className="flex-grow">investigate any complaints.</span>
                  </div>
              ...
              <div className="flex py-3">
                <span className="mr-2 font-semibold">(C)</span>
                <span className="flex-grow">
                  We may disclose your personal information to comply with a legal requirement, such
                  as a law, regulation, court order, subpoena, warrant, legal proceedings or in
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                  Family Fortunate will comply with the principles of data protection set out in the
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  We process your personal information if it is necessary to protect your life or in
                  a medical situation, it is necessary to carry out a public function, a task of
                  public interest or if the function has a clear basis in law.
                </span>
              </div>
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  We do not collect or process any personal information from you that is considered
                  &quot;Sensitive Personal Information&quot; under the GDPR, such as personal
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  You must not provide us with your personal information if you are under the age of
                  16 without the consent of your parent or someone who has parental authority for
                  you. We do not knowingly collect or process the personal information of children.
                </span>
              </div>
            </li>
          </ol>
            ...
            <li className="text-left">
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  ...
                  each of these Countries will be protected by appropriate safeguards, these include
                  one or more of the following: the use of standard data protection clauses adopted
                  or approved by the European Commission which you can obtain from the European
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  ...
                  these Countries will be protected by appropriate safeguards, these include one or
          ...
          <ol className="mx-5">
            <li className="text-left">
              ...
              <div className="flex py-3">
                <span className="mr-2 font-semibold">(B)</span>
                <span className="flex-grow">
                  Where we employ data processors to process personal information on our behalf, we
                  only do so on the basis that such data processors comply with the requirements
                  under the GDPR and that have adequate technical measures in place to protect
                  personal information against unauthorised use, loss and theft.
                </span>
              </div>
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  applicable the EU GDPR. If you would like a copy of the information which we hold
                  about you or believe that any information we hold on you is inaccurate, out of
                  date, incomplete, irrelevant or misleading, please email us at
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  in details of your complaints to hello@familyfortunate.us. We take complaints very
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  modify this Policy at any time, in our sole discretion and all modifications will
                  be effective immediately upon our posting of the modifications on our website or
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                  <p style={{ fontStyle: 'italic' }}>When you visit our website</p>Please be aware
                  that we may change this Privacy Policy in the future. We may modify this Policy at
                  any time, in our sole discretion and all modifications will be effective
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(B)</span>
                <span className="flex-grow">
                  <p style={{ fontStyle: 'italic' }}>Cookies</p>We may from time to time use cookies
                  on our website. Cookies are very small files which a website uses to identify you
                  when you come back to the site and to store details about your use of the site.
                  Cookies are not malicious programs that access or damage your computer. Most web
                  ...
                  analyses website traffic and help us provide a better website visitor experience.
                  In addition, cookies may be used to serve relevant ads to website visitors through
                  third party services such as Google AdWords. These ads may appear on this website
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(C)</span>
                <span className="flex-grow">
                  <p style={{ fontStyle: 'italic' }}>Third party sites</p>Our site may from time to
                  time have links to other websites not owned or controlled by us. These links are
                  meant for your convenience only. Links to third party websites do not constitute
                  sponsorship or endorsement or approval of these websites. Please be aware that
                  Family Fortunate is not responsible for the privacy practises of other such
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                ...
                <span className=" flex-grow">This policy is effective from 10th May 2023.</span>
              </div>
            </li>
          </ol>
        </div>
