...
const Settings = () => {
  ...
  return (
    <MemberLayout>
      ...
      <div className="max-w-auto relative overflow-x-auto rounded-lg bg-white p-2 lg:p-8 dark:bg-[#212325]">
        <div className="max-w-auto flex flex-col gap-4 lg:gap-8">
          <div>
            ...
            <div className="mt-4 flex items-center justify-between rounded-xl p-4 shadow-sm">
              <div className="flex items-center gap-2 lg:gap-6">
                <div className="rounded-full p-2 ring-1 ring-[#9E7558] dark:ring-[#9E7558]">
                  {/**<img src="/member/diamond.svg/" className="w-4 lg:w-8 " alt={'Diamond Icon'} />**/}
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" className='text-[#9E7558] dark:text-[#9E7558]'>
                  <path
          ...
          <div>
            ...
            <div className="mt-4 flex items-center justify-between rounded-xl p-4 shadow-sm">
              <div className="flex items-center gap-2 lg:gap-6">
                <div className="rounded-full p-2 ring-1 ring-[#9E7558] dark:ring-[#9E7558] ">
                  <p className="text-xs font-medium text-[#9E7558] lg:text-lg dark:text-[#9E7558]">
          ...
          <div>
            ...
            <div className="mt-4 flex items-start justify-between rounded-xl p-4 shadow-sm lg:items-center">
              <div className="flex items-start gap-2 lg:items-center lg:gap-6">
                <div className="rounded-full p-2 ring-1 ring-[#9E7558] ">
                  <Cog8ToothIcon className="w-4 text-[#9E7558] lg:w-8" />
                </div>
                <div>
                  <h4 className="text-sm font-light lg:text-base">
