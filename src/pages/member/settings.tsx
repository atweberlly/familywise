...
const Settings = () => {
  ...
  return (
    <MemberLayout>
      ...
      <div className="max-w-auto relative overflow-x-auto rounded-lg bg-white p-2 dark:bg-[#212325] lg:p-8">
        <div className="max-w-auto flex flex-col gap-4 lg:gap-8">
              ...
              <div className="flex items-center gap-2 lg:gap-6">
                <div className="rounded-full p-2 ring-1 ring-[#9E7558] dark:ring-[#9E7558]">
                  ...
                  <svg
                    ...
                    className="text-[#9E7558] dark:text-[#9E7558]"
                  >
                    <path
          ...
          <div>
            ...
            <div className="mt-4 flex items-center justify-between rounded-xl p-4 shadow-sm">
              <div className="flex items-center gap-2 lg:gap-6">
                <div className="rounded-full p-2 ring-1 ring-[#9E7558] dark:ring-[#9E7558] ">
                  <p className="text-xs font-medium text-[#9E7558] dark:text-[#9E7558] lg:text-lg">
