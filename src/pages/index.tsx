    ...
    <div>
      ...
      <header className="bg-white text-black">
        ...
        <div className="section container">
          ...
          <div className="mx-auto my-8 max-w-screen-md lg:my-16 xl:my-32">
            <h2 className="text-center font-fair text-2xl lg:text-5xl xl:text-5xl">
        ...
        <section>
          <div className="aspect-video h-auto bg-black lg:h-[500px]">
