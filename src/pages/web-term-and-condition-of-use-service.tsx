...
export default function refund_policy() {
  return (
    <main className="relative min-h-screen bg-white">
      <Title suffix="Family Fortunate">Website Terms And Conditions Of Use Services</Title>
      <header>
        <Header color="dark" />
        ...
        <div className="mx-7 p-4 py-20 text-left">
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  Welcome to Family Fortunate (<a className="font-bold">Website</a>). The Website
                  provides inspirational prompts to assist members in writing their memoirs (
              ...
              <div className="flex py-3">
                ...
                <span className="flex-grow">
                  The Website is operated by Family Fortunate. Access to and use of the Website, or
                  any of its associated Products or Services, is provided by Family Fortunate.
                  Please read these terms and conditions (<a className="font-bold">Terms</a>)
            ...
            <li className="text-left">
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  you by Family Fortunate in the user interface.
                </span>
              </div>
            </li>
          </ol>
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                  In order to access the Services, you must first register for an account through
                  the Website (<a className="font-bold">Account</a>).
                </span>
              </div>
              ...
              <div className="flex">
                ...
                <span className="flex-grow">
                  ...
                  as identification or contact details), including:
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(i)</span>
                    <span className="flex-grow">Email address</span>
                  </div>
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(ii)</span>
                    <span className="flex-grow">Preferred username</span>
                  </div>
                  <div className="mx-2 my-2 flex">
                  ...
                  <div className="mx-2 my-2 flex">
                    ...
                    <span className="flex-grow">
                      Any names, locations, personal anecdotes etc inlcuded in your stories
                    </span>
                  </div>
                </span>
              </div>
              ...
              <div className="flex">
                ...
                <span className="flex-grow">
                  Once you have completed the registration process, you will be a registered member
                  of the Website (<a className="font-bold">Member</a>) and agree to be bound by the
                  Terms.
                </span>
                <div />
              </div>
              ...
              <div className="flex">
                ...
                You may not use the Services and may not accept the Terms if:
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(i)</span>
                    <span className="flex-grow">you are not of legal age to form a binding contract with Family Fortunate; or</span>
                  </div>
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(ii)</span>
                    <span className="flex-grow">
            ...
            <li className="text-left">
              <div className="flex">
                ...
                As a Member, you agree to comply with the following:
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(i)</span>
                    <span className="flex-grow">you will use the Services only for purposes that are permitted by:
                    <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(A)</span>
                    <span className="flex-grow">the Terms; and</span>
                    </div>
                    <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(B)</span>
                    <span className="flex-grow">any applicable law, regulation or generally accepted practices or guidelines
                      in the relevant jurisdictions;</span>
                  </div>
                    </span>
                  </div>
                  <div className="mx-2 my-2 flex">
                  ...
                  <div className="mx-2 my-2 flex">
                    ...
                    strictly prohibited. You agree to immediately notify Family Fortunate of any
                  ...
                  <div className="mx-2 my-2 flex">
                    ...
                    use of the Website by you for the purposes of Family Fortunate providing the
                    Services;
                    </span>
                  </div>
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(v)</span>
                    <span className="flex-grow">
                  ...
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(vi)</span>
                    <span className="flex-grow">
                  ...
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(vii)</span>
                    <span className="flex-grow">
                    ...
                    termination of the Services. Appropriate legal action will be taken by Family
                    Fortunate for any illegal or unauthorised use of the Website; and
                    </span>
                  </div>
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(viii)</span>
                    <span className="flex-grow">
                    you acknowledge and agree that any automated use of the Website or its Services
                    is prohibited.
                    </span>
                  </div>
                </span>
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                Where the option is given to you, you may make payment for the Services (<a className='font-bold'>Service Fee</a>)
                  by way of
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(i)</span>
                    <span className="flex-grow">
                      Credit Card Payment (<a className='font-bold'>Credit Card</a>)
                    </span>
                  </div>
                  <div className="mx-2 my-2 flex">
                    <span className="mr-2 font-semibold">(ii)</span>
                    <span className="flex-grow">
                    PayPal (<a className='font-bold'>Paypal</a>)
                    </span>
                  </div>
                </span>
              </div>
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(C)</span>
                <span className="flex-grow">
                You acknowledge and agree that where a request for the payment of the Services Fee is
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(D)</span>
                <span className="flex-grow">
                You agree and acknowledge that Family Fortunate can vary the Services Fee at any time.
                </span>
              </div>
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                Family Fortunate will only provide you with a refund of the Services Fee in the event they are
                unable to continue to provide the Services or if the manager of Family Fortunate makes a
                decision, at its absolute discretion, that it is reasonable to do so under the circumstances
                (<a className='font-bold'>Refund</a>)
                </span>
              </div>
            </li>
          </ol>
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex py-3">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                The Website, the Services and all of the related products of Family Fortunate are subject
              ...
              <div className="flex py-3">
                ...
                Family Fortunate, who grants to you a worldwide, non-exclusive, royalty-free, revocable
                ...
                Family Fortunate does not grant you any other rights whatsoever in relation to the Website
                or the Services. All other rights are expressly reserved by Family Fortunate.
                </span>
              </div>
              ...
              <div className="flex py-3">
                  <span className="mr-2 font-semibold">(C)</span>
                  <span className="flex-grow">
                  Family Fortunate retains all rights, title and interest in and to the Website and all related
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(D)</span>
                <span className="flex-grow">
                You may not, without the prior written permission of Family Fortunate and the permission
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                Family Fortunate takes your privacy seriously and any information provided through your
                use of the Website and/or Services are subject to Family Fortunate's Privacy Policy, which
            ...
            <li className="text-left">
              ...
              <div className="flex">
                ...
                <div className="flex">
                  ...
                  <span className=" flex-grow">
                  Family Fortunate will not be liable for any special, indirect or consequential loss or
              ...
              <div className="flex">
                  ...
                  licensors of Family Fortunate make any express or implied representation or warranty
                  about the Services or any products or Services (including the products or Services of
                  Family Fortunate) referred to on the Website. This includes (but is not restricted to) loss or
                  ...
                  <div className="flex">
                    ...
                    products of Family Fortunate; and
                    </span>
                  </div>
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                Family Fortunate's total liability arising out of or in connection with the Services or these
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(B)</span>
                <span className="flex-grow">
                You expressly understand and agree that Family Fortunate, its affiliates, employees,
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                The Terms will continue to apply until terminated by either you or by Family Fortunate as
                set out below.
                </span>
              </div>
              ...
              <div className="flex">
                ...
                <div className="flex">
                  <span className="mr-2 font-semibold">(i)</span>
                  <span className="flex-grow">
                  providing Family Fortunate with days' notice of your intention to terminate; and
                  </span>
                </div>
                ...
                <div className="flex">
                  <span className="mr-2 font-semibold">(ii)</span>
                  <span className="flex-grow">
                  closing your accounts for all of the services which you use, where Family Fortunate
              ...
              Your notice should be sent, in writing, to Family Fortunate via the 'Contact Us' link on our
              homepage.
              <div className="flex">
                  <span className="mr-2 font-semibold">(C)</span>
                  <span className="flex-grow">
                  Family Fortunate may at any time, terminate the Terms with you if:
                    ...
                    <div className="flex">
                      <span className="mr-2 font-semibold">(ii)</span>
                      <span className="flex-grow">
                      Family Fortunate is required to do so by law;
                      </span>
                    </div>
                    ...
                    <div className="flex">
                      <span className="mr-2 font-semibold">(iii)</span>
                      <span className="flex-grow">
                      the provision of the Services to you by Family Fortunate is, in the opinion of Family
                        Fortunate, no longer commercially viable.
              ...
              <div className="flex">
                <span className="mr-2 font-semibold">(D)</span>
                <span className="flex-grow">
                Subject to local applicable laws, Family Fortunate reserves the right to discontinue or
                ...
                provision of the Terms or any applicable law or if your conduct impacts Family Fortunate's
          ...
          <ol className="mx-5">
            <li className="text-left">
              <div className="flex">
                <span className="mr-2 font-semibold">(A)</span>
                <span className="flex-grow">
                You agree to indemnify Family Fortunate, its affiliates, employees, agents, contributors,
          ...
          <ol className="mx-5">
            <li className="text-left">
                ...
                <div className="flex">
                    <span className="mr-2 font-semibold">(A)</span>
                    <span className="flex-grow">
                      <p className='font-bold'>Compulsory:</p>If a dispute arises out of or relates to the Terms, either party may not commence any
                ...
                <div className="flex">
                    <span className="mr-2 font-semibold">(B)</span>
                    <span className="flex-grow">
                      <p className='font-bold'>Notice:</p>A party to the Terms claiming a dispute (<a className='font-bold'>Dispute</a>) has arisen under the Terms, must give
                ...
                <div className="flex">
                    <span className="mr-2 font-semibold">(C)</span>
                    <span className="flex-grow">
                      <p className='font-bold'>Resolution:</p>On receipt of that notice (<a className='font-bold'>Notice</a>) by that other party, the parties to the Terms (<a className='font-bold'>Parties</a>)
                      must:
                      ...
                      <div className="flex">
                        ...
                        request that an appropriate mediator be appointed by the President of the The Law
                        Society of NSW Mediation Program or his or her nominee;
                        </span>
                      </div>
                      ...
                      <div className="flex">
                        ...
                        undertake to pay any amounts requested by the mediator as a pre-condition to the mediation commencing. The Parties must each pay their own costs associated with
                        the mediation;
                        </span>
                      </div>
                      ...
                      <div className="flex">
                        <span className="mr-2 font-semibold">(iv)</span>
                        <span className="flex-grow">
                        The mediation will be held in Newcastle, Australia.
                        </span>
                      </div>
                ...
                <div className="flex">
                    <span className="mr-2 font-semibold">(D)</span>
                    <span className="flex-grow">
                      <p className='font-bold'>Confidential:</p>All communications concerning negotiations made by the Parties arising out of and in
                ...
                <div className="flex">
                    <span className="mr-2 font-semibold">(E)</span>
                    <span className="flex-grow">
                      <p className='font-bold'>Termination of Mediation:</p>If 30 days have elapsed after the start of a mediation of the Dispute and the Dispute has
          ...
          <ol className="mx-5">
            ...
            <div className="flex">
                    ...
                    <span className="flex-grow">
                    The Services offered by Family Fortunate is intended to be viewed by residents of Australia. In
