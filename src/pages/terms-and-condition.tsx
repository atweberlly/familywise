      ...
      <section className="bg-primary-100 leading-normal md:leading-loose">
        <div className="mx-auto max-w-screen-xl px-8 py-10 md:px-16 md:py-20">
          <ol className="mt-4 flex list-none flex-col gap-4 text-justify md:gap-8">
              ...
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                <li>
                  <p>
                    ...
                    the Website (<span className="font-semibold">Account</span>).
                  </p>
                </li>
                <li>
                  <p>
                  ...
                  <ol className="my-5 list-[lower-roman] pl-10">
                    ...
                    <li>Password</li>
                    <li>Any names, locations, personal anecdotes etc inlcuded in your stories</li>
                  </ol>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    member of the Website (<span className="font-semibold">Member</span>) and agree
                ...
                <li>
                  ...
                  <ol className="my-5 list-[lower-roman] pl-10">
                    <li>
                      ...
                      <ul className="flex list-outside list-[lower-alpha] flex-col gap-4 pl-10">
                        <li>the Terms; and</li>
                        <li>
            ...
            <li>
              <h3 className="py-5 text-lg font-semibold text-black-pearl md:text-xl">5. Payment</h3>
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                <li>
                  <p>
                    Where the option is given to you, you may make payment for the Services (
                    <span className="font-semibold">Services Fee</span>) by way of:
                  </p>
                  <ol className="my-5 list-[lower-roman] pl-10">
                    <li>
                      Credit Card Payment (<span className="font-semibold">Credit Card</span>)
                    </li>
                    <li>
                      PayPal (<span className="font-semibold">PayPal</span>)
                    </li>
                  </ol>
                </li>
                <li>
              ...
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                ...
                <li>
                  <p>
                    ...
                    on the Website, which are freely available for re-use or are in the public
                    domain.
                  </p>
                </li>
              </ul>
            ...
            <li>
              <h3 className="py-5 text-lg font-semibold text-black-pearl md:text-xl">8. Privacy</h3>
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                <li>
                  <p>
            ...
            <li>
              ...
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                ...
                <li>
                  <p>
                    Use of the Website and the Services is at your own risk. Everything on the
            ...
            <li>
              ...
              <ul className="flex list-outside list-[upper-alpha] flex-col gap-4 pl-10">
                <li>
                  <p className="font-semibold">Compulsory:</p>
                  <p>
                ...
                <li>
                  ...
                  <p>
                    ...
                    <span className="font-semibold">Dispute</span>) has arisen under the Terms, must
                ...
                <li>
                  ...
                  <p>
                    On receipt of that notice (<span className="font-semibold">Notice</span>) by
                    that other party, the parties to the Terms (
                    <span className="font-semibold">Parties</span>) must:
                  </p>
                  <ol className="my-5 list-[lower-roman] pl-10">
                    <li>
                    ...
                    <li>The mediation will be held in Newcastle, Australia.</li>
                  </ol>
                </li>
                <li>
                ...
                <li>
                  <p className="font-semibold">Termination of Mediation:</p>
                  <p>
