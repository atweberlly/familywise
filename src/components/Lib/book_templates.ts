...
export const book_templates: Array<Props> = [
  ...
  //Template 3
  {
    ...
    title: 'mt-20 -mb-20 text-5xl italic uppercase text-center',
    sTitle: 'mt-20 -mb-20 pt-10 text-5xl italic uppercase text-center',
  ...
  // Template 4
  {
    ...
    title: 'mt-40 -mb-20 text-5xl uppercase  text-center',
    sTitle: 'mt-40 pt-10 -mb-20 text-5xl uppercase text-center',
