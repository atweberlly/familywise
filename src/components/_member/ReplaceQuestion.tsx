...
export default function ReplaceQuestion({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'shadow-md fixed top-1/2 left-1/2 z-30 flex min-w-[20rem] max-w-md -translate-x-1/2 -translate-y-1/2 flex-col gap-6 overflow-hidden rounded-xl bg-gray-100 transition-all lg:min-w-[50rem] lg:max-w-lg',
          showReplace ? 'visible opacity-100' : 'invisible opacity-0'
        )}
      >
        <div className="flex items-center justify-between bg-white p-4">
          <div className="">
            <h4 className="text-lg font-semibold text-gray-800">Replace a question for yourself</h4>
            <p className="text-secondary-400">Browse our list to spark ideas</p>
          </div>
        ...
        <div className="flex h-full flex-col justify-between px-5 py-10">
