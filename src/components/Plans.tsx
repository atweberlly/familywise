...
export default function Plans({ name, price, features, isPopular, userId }: any) {
  ...
  return (
    <div className="max-w-full text-left md:max-w-sm">
      <Card
        className={`cursor-pointer transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:border-2 hover:border-primary-300 hover:shadow dark:bg-white ${
