...
export default function MemberLayout({ children }: any) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#f5f6f8] dark:bg-[#323337] dark:text-white">
      <header className="bg-white px-4 py-6 dark:bg-[#111315] dark:text-white xl:px-8 ">
      ...
      <div className="relative flex flex-1  ">
        <aside
          className={clsx(
            'absolute top-0 bottom-0 z-10 min-w-[256px] bg-white  px-4 pt-4 shadow-lg transition-all dark:bg-[#111315] dark:text-white md:static xl:min-w-[320px]',
